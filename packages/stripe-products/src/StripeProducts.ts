...
export const FrontendProductsDev: FrontendProductsType[] = [
  {
    name: '500 credits',
    description: '500 credits for Jobstream',
    default_price_data: {
...
export const FrontendProductsProd: FrontendProductsType[] = [
  {
    name: '500 credits',
    description: '500 credits for Jobstream',
    default_price_data: {
      currency: 'usd',
      unit_amount: 500,
      priceId: 'price_1OCgtGIUxCL9zUiYwI95owpf',
    },
  },
  {
    name: '1500 credits',
    ...
    default_price_data: {
      currency: 'usd',
      unit_amount: 1000,
      priceId: 'price_1OCgtGIUxCL9zUiYHt9X79sY',
    },
  },
  {
    name: '3500 credits',
    ...
    default_price_data: {
      currency: 'usd',
      unit_amount: 2000,
      priceId: 'price_1OCgtGIUxCL9zUiYeZU5qbly',
    },
  },
  {
    name: '8000 credits',
    ...
    default_price_data: {
      currency: 'usd',
      unit_amount: 4000,
      priceId: 'price_1OCgtGIUxCL9zUiYyCj3ZgB7',
    },
  },
];