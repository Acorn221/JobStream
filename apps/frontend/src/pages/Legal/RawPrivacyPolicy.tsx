...
export const RawPrivacyPolicy = () => (
     ...
     <div data-custom-class="body">
       ...
       <div>
         ...
         <div style={{ lineHeight: '1.5' }}>
           ...
           <a data-custom-class="link" href="#toc"><span style={{ fontSize: '15px' }}><span data-custom-class="body_text"><strong><em>table of contents</em></strong></span></span></a>
         ...
         <div style={{ lineHeight: '1.5' }}>
           ...
           <a data-custom-class="link" href="#personalinfo"><span style={{ fontSize: '15px' }}><span data-custom-class="body_text">personal information you disclose to us</span></span></a>
         ...
         <div style={{ lineHeight: '1.5' }}>
           ...
           <a data-custom-class="link" href="#infouse"><span style={{ fontSize: '15px' }}><span data-custom-class="body_text">how we process your information</span></span></a>
           <span data-custom-class="body_text">.</span>
         </div>
         <div style={{ lineHeight: '1.5' }}><br /></div>
         <div style={{ lineHeight: '1.5' }}>
           ...
           <a data-custom-class="link" href="#whoshare"><span style={{ fontSize: '15px' }}><span data-custom-class="body_text">when and with whom we share your personal information</span></span></a>
           <span style={{ fontSize: '15px' }}>
             <span data-custom-class="body_text">
               .
               <BDT className="block-component" />
         ...
         <div style={{ lineHeight: '1.5' }}>
           ...
           <a data-custom-class="link" href="#infosafe"><span style={{ fontSize: '15px' }}><span data-custom-class="body_text">how we keep your information safe</span></span></a>
           <span data-custom-class="body_text">.</span>
           <span style={{ fontSize: '15px' }}>
             <span data-custom-class="body_text">
               <BDT className="statement-end-if-in-editor" />
         ...
         <div style={{ lineHeight: '1.5' }}>
           ...
           <a data-custom-class="link" href="#privacyrights"><span style={{ fontSize: '15px' }}><span data-custom-class="body_text">your privacy rights</span></span></a>
           <span data-custom-class="body_text">.</span>
         </div>
         <div style={{ lineHeight: '1.5' }}><br /></div>
         <div style={{ lineHeight: '1.5' }}>
         ...
         <div style={{ lineHeight: '1.5' }}>
           ...
           <a data-custom-class="link" href="#toc"><span style={{ fontSize: '15px' }}><span data-custom-class="body_text">Review the privacy notice in full</span></span></a>
         ...
         <div style={{ lineHeight: '1.5' }}><span style={{ fontSize: '15px' }}><span style={{ color: 'rgb(89, 89, 89)' }}><a data-custom-class="link" href="#privacyrights">9. WHAT ARE YOUR PRIVACY RIGHTS?</a></span></span></div>
         <div style={{ lineHeight: '1.5' }}>
           <span style={{ fontSize: '15px' }}>
         ...
         <div style={{ lineHeight: '1.5' }}>
           <span style={{ fontSize: '15px' }}><a data-custom-class="link" href="#uslaws"><span style={{ color: 'rgb(89, 89, 89)' }}>11. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</span></a></span>
           <BDT className="block-component"><span style={{ fontSize: '15px' }}><span data-custom-class="body_text" /></span></BDT>
         </div>
         <div style={{ lineHeight: '1.5' }}>
           <a data-custom-class="link" href="#otherlaws"><span style={{ fontSize: '15px' }}>12. DO OTHER REGIONS HAVE SPECIFIC PRIVACY RIGHTS?</span></a>
           <span style={{ fontSize: '15px' }}>
         ...
         &lt;&gt;
         <div style={{ lineHeight: '1.5' }}><span style={{ fontSize: '15px' }}><a data-custom-class="link" href="#policyupdates"><span style={{ color: 'rgb(89, 89, 89)' }}>13. DO WE MAKE UPDATES TO THIS NOTICE?</span></a></span></div>
         <div style={{ lineHeight: '1.5' }}><a data-custom-class="link" href="#contact"><span style={{ color: 'rgb(89, 89, 89)', fontSize: '15px' }}>14. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</span></a></div>
         <div style={{ lineHeight: '1.5' }}><a data-custom-class="link" href="#request"><span style={{ color: 'rgb(89, 89, 89)' }}>15. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</span></a></div>
         <div style={{ lineHeight: '1.5' }}><br /></div>
         <div style={{ lineHeight: '1.5' }}><br /></div>
           ...
           <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
             <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
               <span data-custom-class="body_text">
                 ...
                 '
                 <BDT className="else-block" />
                 <span style={{ fontSize: '15px' }}><span data-custom-class="body_text"><span style={{ fontSize: '15px' }}><span style={{ color: 'rgb(89, 89, 89)' }}><a data-custom-class="link" href="#sociallogins">HOW DO WE HANDLE YOUR SOCIAL LOGINS?</a></span></span></span></span>
                 <BDT className="block-component" />
                 '
                 <BDT className="else-block" />
                 {' '}
                                             ...
                                             <div style={{ lineHeight: '1.5' }}>
                                                   ...
                                                   <ul>
                                                     <li style={{ lineHeight: '1.5' }}>
                                                       ...
                                                       <a data-custom-class="link" href="#withdrawconsent"><span style={{ fontSize: '15px' }}><span data-custom-class="body_text">withdrawing your consent</span></span></a>
                                                       <span data-custom-class="body_text">.</span>
                                                     </li>
                                                   </ul>
                                                   <div style={{ lineHeight: '1.5' }}>
                                                   ...
                                                   <div style={{ lineHeight: '1.5' }}>
                                                     ...
                                                     <a data-custom-class="link" href="#withdrawconsent"><span data-custom-class="body_text"><span style={{ fontSize: '15px' }}>withdraw your consent</span></span></a>
 ...
 {' '}
                                                         ...
                                                         <div style={{ lineHeight: '1.5' }}>
                                                           ...
                                                           <a data-custom-class="link" href="#contact"><span style={{ fontSize: '15px' }}><span data-custom-class="body_text">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</span></span></a>
                                                           <span style={{ fontSize: '15px' }}>
                                                             <span data-custom-class="body_text">
                                                               <BDT className="block-component" />
                                                               '
 ...
 <div style={{lineHeight: '1.5'}}><span data-custom-class="body_text" style={{fontSize: '15px'}}>Learn about how we use your personal information in the section, <BDT className="block-component" />'<BDT className="else-block" /></span><a href="#infouse"><span data-custom-class="link" style={{fontSize: '15px'}}>HOW DO WE PROCESS YOUR INFORMATION?</span></a><span data-custom-class="body_text" style={{fontSize: '15px'}}><BDT className="block-component" />'<BDT className="else-block" /></span></div>&lt;&gt;
 ...
 <span style={{fontSize: '15px', color: 'rgb(89, 89, 89)'}}><span style={{fontSize: '15px', color: 'rgb(89, 89, 89)'}}><span data-custom-class="body_text">We may disclose your personal information with our service providers pursuant to a written contract between us and each service provider. Learn more about how we disclose personal information to in the section, <BDT className="block-component" />'<BDT className="else-block" /></span></span></span><a href="#whoshare"><span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}><span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}><span data-custom-class="link">WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</span></span></span></a>
